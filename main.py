...
##CONNECT TO DB
#  changed this to connect to postgres database on heroku.  also transferred the secret key above. SQLite database
# is subject to getting moved around on Heroku and having to re-initialize it and losing your data.
